...
var o = class {
	...
	async render(e, n, r) {
		...
		a = a.replace(/\{\{label\}\}/g, i.label?.en ?? "{{label}}").replace(/\{\{description\}\}/g, i.description?.en ?? "{{description}}"), this.micromarkTool = await this.loadMicromarkTool(), n.innerHTML = await this.micromarkTool.render(a, { tables: !0 }), this.micromarkTool.highlight(n, this.colorModeId), this.highchartsTool = await this.loadHighchartsTool();
